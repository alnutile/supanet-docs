...
Meeting Notes requires your workspace admin to configure the **OpenAI API key**. If you see an error like "Transcription is not configured," ask an admin to set the `OPENAI_KEY` edge-function secret. Once configured, transcription will work immediately.
