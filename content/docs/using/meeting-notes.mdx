...
1. Click **Save as Artifact**. SupaNet formats the transcript as markdown, adding:
   ...
   - If ideas were surfaced during recording, they appear as an "Ideas & Prompts" section.
   - If you had a chat conversation during the recording, the full chat history appears as a "Chat" section so the saved artifact is a complete record.
...
The artifact also stores metadata recording the duration, idea count, and whether it includes chat, so you can filter or organize them later.
