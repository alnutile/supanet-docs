...
The **Security** page (admin-only, under Governance in the sidebar) has a **"Run scan"** button. When you press it, SupaNet checks:
...
The scan then displays a summary and lists any **open findings**.
